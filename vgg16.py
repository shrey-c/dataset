...
Original file is located at
    https://colab.research.google.com/drive/1dticbUFSXbvIyCLBn0bz5ia84vEEq4Ot
"""

!git clone https://github.com/shrey-c/dataset
...
def CNN_Model(pretrained):
    model = models.vgg16_bn(pretrained, num_classes=1000)
    print(model)
